        ...
        <div class="min-h-screen lg:flex">
            <aside class="border-b border-outline-variant bg-surface-container-low px-4 py-4 lg:fixed lg:inset-y-0 lg:left-0 lg:z-40 lg:w-[260px] lg:border-b-0 lg:border-r">
                ...
                <nav class="mt-8 grid gap-1 text-body-sm font-medium">
                    ...
                    <a href="{{ route('dashboard.pages.index') }}" class="flex items-center gap-3 rounded px-4 py-2.5 transition hover:bg-surface-container-high {{ $pagesActive ? 'bg-secondary-container font-semibold text-on-secondary-container' : 'text-on-surface-variant' }}">
                        <span class="material-symbols-outlined text-[20px]">description</span>
                        Paginas
                    </a>
                    <a href="{{ route('dashboard.pages.index') }}" class="flex items-center gap-3 rounded px-4 py-2.5 transition hover:bg-surface-container-high {{ $sectionsActive ? 'bg-secondary-container font-semibold text-on-secondary-container' : 'text-on-surface-variant' }}">
