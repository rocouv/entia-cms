<x-dashboard-layout title="Nueva pagina">
    <section class="mb-8">
    ...
    <form method="POST" action="{{ route('dashboard.pages.store') }}" class="grid gap-6 lg:grid-cols-3">
        @csrf
            ...
            <section class="border border-outline-variant bg-surface-container-lowest">
                ...
                <div class="grid gap-5 p-6">
                    <label class="grid gap-2">
                        ...
                        <input name="title" value="{{ old('title') }}" required class="h-10 rounded border border-outline-variant bg-surface px-3 text-body-md outline-none transition focus:border-primary">
                        @error('title') <span class="text-body-sm text-error">{{ $message }}</span> @enderror
                    </label>

                    <label class="grid gap-2">
                        <span class="text-label-md text-on-surface">Slug</span>
                        <input name="slug" value="{{ old('slug') }}" placeholder="sobre-nosotros" class="h-10 rounded border border-outline-variant bg-surface px-3 text-body-md outline-none transition focus:border-primary">
                    ...
                    <label class="grid gap-2">
                        ...
                        <textarea name="excerpt" rows="3" class="rounded border border-outline-variant bg-surface px-3 py-2 text-body-md outline-none transition focus:border-primary">{{ old('excerpt') }}</textarea>
                    ...
                    <label class="grid gap-2">
                        ...
                        <textarea name="body" rows="8" class="rounded border border-outline-variant bg-surface px-3 py-2 text-body-md outline-none transition focus:border-primary">{{ old('body') }}</textarea>
            ...
            <section class="border border-outline-variant bg-surface-container-lowest">
                ...
                <div class="grid gap-5 p-6">
                    <label class="grid gap-2">
                        ...
                        <input name="meta_title" value="{{ old('meta_title') }}" class="h-10 rounded border border-outline-variant bg-surface px-3 text-body-md outline-none transition focus:border-primary">
                    ...
                    <label class="grid gap-2">
                        ...
                        <textarea name="meta_description" rows="3" class="rounded border border-outline-variant bg-surface px-3 py-2 text-body-md outline-none transition focus:border-primary">{{ old('meta_description') }}</textarea>
            ...
            <div class="border border-outline-variant bg-surface-container-lowest p-6">
                ...
                <div class="mt-4 space-y-4">
                    <label class="flex items-center gap-3">
                        <input name="is_home" type="checkbox" value="1" @checked(old('is_home')) class="size-4 rounded border-outline-variant text-primary focus:ring-primary focus:ring-offset-0">
                        <span class="text-body-sm text-on-surface-variant">Usar como home</span>
                    </label>
                    <label class="flex items-center gap-3">
                        <input name="is_published" type="checkbox" value="1" @checked(old('is_published')) class="size-4 rounded border-outline-variant text-primary focus:ring-primary focus:ring-offset-0">
                        <span class="text-body-sm text-on-surface-variant">Publicada</span>
                    </label>
                    <label class="flex items-center gap-3">
                        <input name="show_in_navigation" type="checkbox" value="1" @checked(old('show_in_navigation')) class="size-4 rounded border-outline-variant text-primary focus:ring-primary focus:ring-offset-0">
            ...
            <div class="border border-outline-variant bg-surface-container-lowest p-6">
                ...
                <div class="mt-4 grid gap-4">
                    <label class="grid gap-2">
                        ...
                        <input name="navigation_label" value="{{ old('navigation_label') }}" class="h-10 rounded border border-outline-variant bg-surface px-3 text-body-md outline-none transition focus:border-primary">
