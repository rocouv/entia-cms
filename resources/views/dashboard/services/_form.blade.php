...
<form method="POST" action="{{ $action }}" class="grid gap-6 lg:grid-cols-3">
        ...
        <section class="border border-outline-variant bg-surface-container-lowest">
            ...
            <div class="grid gap-5 p-6">
                <label class="grid gap-2">
                    ...
                    <input name="title" value="{{ old('title', $service?->title) }}" required class="h-10 rounded border border-outline-variant bg-surface px-3 text-body-md outline-none transition focus:border-primary">
                    @error('title') <span class="text-body-sm text-error">{{ $message }}</span> @enderror
                </label>

                <label class="grid gap-2">
                    <span class="text-label-md text-on-surface">Slug</span>
                    <input name="slug" value="{{ old('slug', $service?->slug) }}" placeholder="branding-e-identidad" class="h-10 rounded border border-outline-variant bg-surface px-3 text-body-md outline-none transition focus:border-primary">
                ...
                <label class="grid gap-2">
                    ...
                    <textarea name="excerpt" rows="3" class="rounded border border-outline-variant bg-surface px-3 py-2 text-body-md outline-none transition focus:border-primary">{{ old('excerpt', $service?->excerpt) }}</textarea>
                ...
                <label class="grid gap-2">
                    ...
                    <textarea name="body" rows="8" class="rounded border border-outline-variant bg-surface px-3 py-2 text-body-md outline-none transition focus:border-primary">{{ old('body', $service?->body) }}</textarea>
        ...
        <section class="border border-outline-variant bg-surface-container-lowest">
            ...
            <div class="grid gap-5 p-6">
                <label class="grid gap-2">
                    ...
                    <input name="meta_title" value="{{ old('meta_title', $service?->meta_title) }}" class="h-10 rounded border border-outline-variant bg-surface px-3 text-body-md outline-none transition focus:border-primary">
                ...
                <label class="grid gap-2">
                    ...
                    <textarea name="meta_description" rows="3" class="rounded border border-outline-variant bg-surface px-3 py-2 text-body-md outline-none transition focus:border-primary">{{ old('meta_description', $service?->meta_description) }}</textarea>
    ...
    <aside class="space-y-6">
        <div class="border border-outline-variant bg-surface-container-lowest p-6">
            ...
            <div class="mt-4 space-y-4">
                <label class="flex items-center gap-3">
                    <input name="is_published" type="checkbox" value="1" @checked(old('is_published', $service?->is_published ?? false)) class="size-4 rounded border-outline-variant text-primary focus:ring-primary focus:ring-offset-0">
                    <span class="text-body-sm text-on-surface-variant">Publicado</span>
                </label>
                <label class="flex items-center gap-3">
                    <input name="is_featured" type="checkbox" value="1" @checked(old('is_featured', $service?->is_featured ?? false)) class="size-4 rounded border-outline-variant text-primary focus:ring-primary focus:ring-offset-0">
        ...
        <div class="border border-outline-variant bg-surface-container-lowest p-6">
            ...
            <div class="mt-4 grid gap-4">
                ...
                <label class="grid gap-2">
                    ...
                    <input name="sort_order" type="number" min="0" value="{{ old('sort_order', $service?->sort_order ?? 0) }}" required class="h-10 rounded border border-outline-variant bg-surface px-3 text-body-md outline-none transition focus:border-primary">
        ...
        <div class="border border-outline-variant bg-surface-container-lowest p-6">
            ...
            <div class="mt-4 grid gap-4">
                <label class="grid gap-2">
                    ...
                    <input name="image_path" list="service-image-media" value="{{ old('image_path', $service?->image_path) }}" placeholder="media/servicio.jpg" class="h-10 rounded border border-outline-variant bg-surface px-3 text-body-md outline-none transition focus:border-primary">
                    <datalist id="service-image-media">
        ...
        <div class="border border-outline-variant bg-surface-container-lowest p-6">
            ...
            <a href="{{ route('dashboard.services.index') }}" class="mt-3 flex h-11 w-full items-center justify-center rounded border border-outline-variant text-label-md text-primary transition hover:bg-surface-container-low">
                Cancelar
            </a>
        </div>
    </aside>
